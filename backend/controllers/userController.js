...
export const follow=async(req,res)=>{
    try{
        ...
        const loggedInUser=await User.findById(loggedInUserId); //Nitin
        const user=await User.findById(userId);//Rahul
        if(!user.follwers.include(loggedInUserId)){
